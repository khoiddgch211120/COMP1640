...
var AdminDashboard = function () {
  ...
  async function loadFilters() {
    ...
    try {
      ...
      var rawYears = Array.isArray(results[0]) ? results[0] : results[0]?.content ?? [];
  ...
  async function fetchReport(yearId, deptFilter) {
    ...
    try {
      var deptId =
        deptFilter !== "overall" && deptFilter ? Number(deptFilter) : null;
      var raw = await getStatisticsReport(yearId || undefined, deptId);
